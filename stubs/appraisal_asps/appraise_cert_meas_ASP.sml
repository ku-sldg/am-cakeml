(* Appraisal Stub code for ASP with asp ID:  cert_id *)

(* appraise_cert_meas_asp_stub :: coq_ASP_PARAMS -> coq_Plc -> coq_BS -> coq_RawEv -> coq_BS *)
fun appraise_cert_meas_asp_stub ps p bs ls =
