...
SERVER_P1_EXE_NAME=TEST_SERVER_AM_P1_EXE
...
if [[ "$PWD" == */am-cakeml/tests ]]; then
  ...
  # Start the P3 server
  tmux send-keys -t 1 "( $BUILT_SERVER_AM_P3 -m $SERVER_P3_FORM_MAN -k $SERVER_PRIV_KEY )" Enter
