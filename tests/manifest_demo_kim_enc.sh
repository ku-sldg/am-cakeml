...
DEMO_FILES=../tests/DemoFiles/KimEnc
...
CLIENT_TERM_FILE_JSON=$DEMO_FILES/ClientCvmTermKimEnc.json

MANGEN_TERMS_FILE=$DEMO_FILES/ServerPlcTermsKimEnc.json
MANGEN_EVS_FILE=$DEMO_FILES/ServerPlcEvsKimEnc.json
