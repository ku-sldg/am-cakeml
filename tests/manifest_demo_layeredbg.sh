...
if [[ "$PWD" == */am-cakeml/tests ]]; then
  ...
  $MAN_COMP -s $SERVER_P1_TERMS_FILE -o $SERVER_P2_EXE_NAME -om $SERVER_P2_CONC_MAN -m $SERVER_P2_FORM_MAN -l $SERVER_AM_LIB
  $MAN_COMP -s $SERVER_P1_TERMS_FILE -o $SERVER_P3_EXE_NAME -om $SERVER_P3_CONC_MAN -m $SERVER_P3_FORM_MAN -l $SERVER_AM_LIB
  $MAN_COMP -s $SERVER_P1_TERMS_FILE -o $SERVER_P4_EXE_NAME -om $SERVER_P4_CONC_MAN -m $SERVER_P4_FORM_MAN -l $SERVER_AM_LIB
