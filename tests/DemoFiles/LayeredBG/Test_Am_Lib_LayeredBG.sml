...
val appAspMapping = (mapC_from_pairList [
      ...
      ((Coq_pair coq_P3 attest_id), 
        fn par => fn p => fn bs => fn rawEv => appraise_attest_meas_asp_stub par p bs rawEv), 

      ((Coq_pair coq_P4 attest_id), 
        fn par => fn p => fn bs => fn rawEv => appraise_attest_meas_asp_stub par p bs rawEv), 
