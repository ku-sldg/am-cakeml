...
(* am -> asp -> evc -> evc *)
fun primEvC am a e = case a of
      Aspc id args => PairBitsV (BitsV (measureUsm (usmMap am) id args)) e
    | Cpy => e
    | Sig => PairBitsV (BitsV (signEvC am (privKey am) e)) e
    | Hsh => BitsV (genHashC am e)
