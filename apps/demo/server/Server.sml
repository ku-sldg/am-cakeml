...
(* () -> () *)
fun main () =
  let val concreteMan = ManifestJsonConfig.retrieve_concrete_manifest () 
      val (concrete, aspDisp, plcDisp, pubKeyDisp, uuidDisp) = ManifestUtils.setup_and_get_AM_config server_formal_manifest server_am_library concreteMan
