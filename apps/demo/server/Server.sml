...
fun main () =
  let val (concreteMan, privKey) = ManifestJsonConfig.retrieve_CLI_args () 
      ...
      val _ (* (concrete, privKey, aspDisp, plcDisp, pubKeyDisp, uuidDisp) *) = ManifestUtils.setup_and_get_AM_config server_formal_manifest server_am_library concreteMan privKey auth_phrase
