...
fun startServer () =
    let val queueLength = 5 (* TODO: Hardcoded queue length *)
        ...
        val _(* (concrete, privKey, aspDisp, plcDisp, pubKeyDisp, uuidDisp) *) = ManifestUtils.setup_and_get_AM_config formal_manifest client_am_library concreteMan privKey auth_phrase
